...
module.exports = {
  mode: 'production',
  entry: {
    'toponomysearch.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`toponomysearch-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
