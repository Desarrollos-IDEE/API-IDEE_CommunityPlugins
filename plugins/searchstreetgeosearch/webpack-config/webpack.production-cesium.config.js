...
module.exports = {
  mode: 'production',
  entry: {
    'searchstreetgeosearch.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`searchstreetgeosearch-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
  ...
  resolve: {
    alias: {
      ...
      Geosearch: path.resolve(__dirname, '../../geosearch'),
      SearchStreet: path.resolve(__dirname, '../../searchstreet'),
    },
