...
Existe un histórico de versiones de todos los plugins de API-IDEE en [api-idee-legacy](https://github.com/Desarrollos-IDEE/API-IDEE/tree/master/Ejemplo con el plugin viewmanagement, implementación OpenLayers y versión 1.0.0:
- viewmanagement-1.0.0.ol.min.css
- viewmanagement-1.0.0.ol.min.js
