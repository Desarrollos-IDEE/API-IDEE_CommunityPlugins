...
module.exports = {
  mode: 'production',
  entry: {
    'geosearchbylocation.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`geosearchbylocation-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
