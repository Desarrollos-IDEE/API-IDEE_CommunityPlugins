...
```
https://componentes.idee.es/api-idee?=https://geobusquedas-sigc.juntadeandalucia.es/*sigc*/search
```
...
```
```
https://componentes.idee.es/api-idee?archetype=base64=eyJ1cmwiOiJodHRwczovL2dlb2J1c3F1ZWRhcy1zaWdjLmp1bnRhZGVhbmRhbHVjaWEuZXMiLCJjb3JlIjoic2lnYyIsImhhbmRsZXIiOiIvc2VhcmNoPyJ9
```
