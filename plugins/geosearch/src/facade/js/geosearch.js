...
export default class Geosearch extends IDEE.Plugin {
  /**
   * @classdesc
  ...
  addTo(map) {
    ...
    this.control_.on(IDEE.evt.ADD_TO_MAP, this.onLoadCallback_, this);
    this.panel_ = new IDEE.ui.Panel('geosearch', {
      collapsible: true,
